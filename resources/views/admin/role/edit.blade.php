    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Silahkan Edit Data Role</p>
            </div>
        </div>
    </div>
    <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="des" placeholder="Masukkan Deskripsi Role" required>{{ $role->description }}</textarea>
                            </div>
