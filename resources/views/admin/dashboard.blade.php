...
@section('content')
    ...
    <div class="page-heading">
        <h3>Selamat Datang, {{ Auth::user()->role->role_name }}|{{ Auth::user()->fullname }}!</h3>
    </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $totalOrderToday }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ 'Rp' . number_format($totalRevenueToday, 0, ',', '.') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ 'Rp' . number_format($totalRevenues, 0, ',', '.') }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
