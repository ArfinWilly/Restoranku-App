                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cat_name" class="form-control" id="catName"
                                    placeholder="Masukkan Nama Kategory" required>
                            </div>

                            <div class="form-group">
                                <label for="des">Deskripsi</label>
                                <textarea name="description" class="form-control" id="des" placeholder="Masukkan Deskripsi Kategory" required></textarea>
                            </div>
