            ...
            <div class="container py-5">
                ...
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        {{ session('success') }}
                        <button type="button" class="btn-close top-0 end-0" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                @endif
                @if (empty($cart))
                ...
                <div class="d-flex justify-content-end mt-4">
                    <a href="{{ route('clear.cart') }}" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin mengosongkan keranjang?')">Kosongkan Keranjang</a>
                    ...
                    <div class="col-sm-8 col-md-7 col-lg-6 col-xl-4">
                        <div class="bg-light rounded">
                            ...
                            <div class="py-4 mb-4 border-top d-flex justify-content-between">
                                ...
                                <h5 class="mb-0 pe-4">Rp{{ number_format($total, 2, ',', '.') }}</h5>
                            </div>
