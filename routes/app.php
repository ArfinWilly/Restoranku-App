...
Route::middleware(['auth', 'role:admin|chef|cashier|Head of Chef'])->group(function () {
    //
    ...
    Route::post('/orders/{id}', [App\Http\Controllers\OrderController::class, 'updateStatus'])->name('orders.updateStatus');
});
